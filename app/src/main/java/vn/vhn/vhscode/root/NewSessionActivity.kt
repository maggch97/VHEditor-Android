...
class NewSessionActivity : AppCompatActivity() {
    companion object {
        ...
        val kPrefRemoteCodeEditorURL = "PREF_REMOTE_CODEEDITOR_URL"
    }
    ...
    private fun configureUI() {
        ...
        binding.editTxtRemoteServer.setText(
            sharedPreferences().getString(
                kPrefRemoteCodeEditorURL,
    ...
    fun onStartRemote(view: View) {
        ...
        sharedPreferences().edit().putString(kPrefRemoteCodeEditorURL, binding.editTxtRemoteServer.text.toString()).apply()
        finish()
    }
